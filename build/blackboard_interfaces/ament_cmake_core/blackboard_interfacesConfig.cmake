...
if(_blackboard_interfaces_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED blackboard_interfaces_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(blackboard_interfaces_FOUND FALSE)
  elseif(NOT blackboard_interfaces_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(blackboard_interfaces_FOUND FALSE)
  endif()
  return()
endif()
set(_blackboard_interfaces_CONFIG_INCLUDED TRUE)

# output package information
if(NOT blackboard_interfaces_FIND_QUIETLY)
  message(STATUS "Found blackboard_interfaces: 0.0.0 (${blackboard_interfaces_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'blackboard_interfaces' is deprecated")
