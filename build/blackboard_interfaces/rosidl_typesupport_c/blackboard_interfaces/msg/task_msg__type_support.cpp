...
#include "blackboard_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _TaskMsg_type_support_symbol_names_t _TaskMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, blackboard_interfaces, msg, TaskMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, blackboard_interfaces, msg, TaskMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_blackboard_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, blackboard_interfaces, msg, TaskMsg)() {
  return &::blackboard_interfaces::msg::rosidl_typesupport_c::TaskMsg_message_type_support_handle;
}
