...
#include "blackboard_interfaces/msg/detail/task_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_blackboard_interfaces
cdr_serialize(
  const blackboard_interfaces::msg::TaskMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  blackboard_interfaces::msg::TaskMsg & ros_message)
{
  // Member: taskid
  cdr >> ros_message.taskid;
...
{
  auto typed_message =
    static_cast<const blackboard_interfaces::msg::TaskMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<blackboard_interfaces::msg::TaskMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TaskMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const blackboard_interfaces::msg::TaskMsg *>(
...
{
  return max_serialized_size_TaskMsg(full_bounded, 0);
}

static message_type_support_callbacks_t _TaskMsg__callbacks = {
...
static rosidl_message_type_support_t _TaskMsg__handle = {
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_blackboard_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<blackboard_interfaces::msg::TaskMsg>()
{
  return &blackboard_interfaces::msg::typesupport_fastrtps_cpp::_TaskMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, blackboard_interfaces, msg, TaskMsg)() {
  return &blackboard_interfaces::msg::typesupport_fastrtps_cpp::_TaskMsg__handle;
}
