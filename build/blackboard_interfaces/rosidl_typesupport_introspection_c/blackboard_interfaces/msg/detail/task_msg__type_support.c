...
#include <stddef.h>
#include "blackboard_interfaces/msg/detail/task_msg__rosidl_typesupport_introspection_c.h"
...
void TaskMsg__rosidl_typesupport_introspection_c__TaskMsg_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  blackboard_interfaces__msg__TaskMsg__init(message_memory);
}

void TaskMsg__rosidl_typesupport_introspection_c__TaskMsg_fini_function(void * message_memory)
{
  blackboard_interfaces__msg__TaskMsg__fini(message_memory);
}
...
static const rosidl_typesupport_introspection_c__MessageMembers TaskMsg__rosidl_typesupport_introspection_c__TaskMsg_message_members = {
  ...
  TaskMsg__rosidl_typesupport_introspection_c__TaskMsg_init_function,  // function to initialize message memory (memory has to be allocated)
  TaskMsg__rosidl_typesupport_introspection_c__TaskMsg_fini_function  // function to terminate message instance (will not free memory)
};
